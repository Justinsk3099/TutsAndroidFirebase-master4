                ...
                if (user != null) {
                    ...
                    btnview.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Intent intent = new Intent(ActivityGithub.this, display.class);
                    ...
                    btnview.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Toast.makeText(ActivityGithub.this, "Not allowed", Toast.LENGTH_SHORT).show();
